<?php
    ...
    if(!defined("DATABASE_HOST")) define("DATABASE_HOST", 'localhost'); //Database server
    if(!defined("DATABASE_USERNAME")) define("DATABASE_USERNAME", 'root'); //Database username
    if(!defined("DATABASE_PASSWORD")) define("DATABASE_PASSWORD", ''); //Database password
    if(!defined("DATABASE_NAME")) define("DATABASE_NAME", 'bank_project'); //Database name
